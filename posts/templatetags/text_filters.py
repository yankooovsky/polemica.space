...
def resized_image(value, arg="full"):
    if not value or "://i.polemica.community/" not in value:
        return value

    if is_video(value):
        return value

    if value.startswith("https://i.polemica.community/full/"):
        return value.replace(
            "https://i.polemica.community/full/", "https://i.polemica.community/{}/".format(arg)
        )
    else:
        return value
